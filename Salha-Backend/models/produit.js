...
module.exports = class Produit {
    ...
    static post(nom_produit,image_produit,nb_min,id_U){
        return db.execute('INSERT INTO produit (nom_produit,image_produit,nb_min,id_U) VALUES (?,?,?,?)',[nom_produit,image_produit,nb_min,id_U]);
    }
    static update(id_produit, nom_produit,image_produit,nb_min) {
        return db.execute('UPDATE produit SET nom_produit = ?,image_produit = ?,nb_min = ? WHERE id_produit = ?', [nom_produit,image_produit,nb_min,id_produit]);
      }
